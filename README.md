...
- 🇯🇵 **Pixel-Accurate Japanese IME & Real Glyph Metrics**: Full Wayland text-input protocol support (Fcitx5 / Mozc / IBus), live pre-edit underline preview, and direct `cosmic-text` shaped glyph metrics caching (resolving East Asian Ambiguous characters like `――` U+2015) preventing cursor drift.
