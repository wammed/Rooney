...
pub struct App {
    ...
    pub(crate) settings_tab: crate::app::message::SettingsTab,
    pub(crate) expanded_license_idx: Option<usize>,
    ...
    pub(crate) fim_generation: usize,
    pub(crate) ai_chat_generation: usize,
...
"#;
            ...
            right_pane.markdown_doc = Some(crate::markdown::MarkdownDocument::parse(
                sample_md,
                config.markdown_spec,
            ));
        }
        ...
        let app = Self {
            ...
            ai_status,
            show_settings: false,
            settings_tab: crate::app::message::SettingsTab::Aesthetics,
            expanded_license_idx: None,
